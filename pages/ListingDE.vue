  ...
  <div class="container">
    <div class="listing">
      ...
      <div class="listing__section">
        ...
        Um diesen Geocache zu finden, müsst ihr Eintritt für den Zugang zum Schlosshof zahlen - (<strong>außer Montags, dort ist der Eintritt kostenlos.</strong>) Das billigste Ticket kostet 16PLN (13PLN mit Rabatten) und beinhaltet eine Tour mit Führung durch die Kreuzgänge, Fels Dorothea und dem Lagerhaus. Das Ticket <strong>MUSS </strong> für das Finden des Caches <strong>bezahlt</strong> werden, <strong>die Tour muss jedoch nicht angetreten werden</strong> - Nach Betreten des Schlosses kann man die Gruppe einfach verlassen und nach Belieben das Rätsel lösen. Der finale Cache ist ebenfalls im Schloss versteckt.<br>
        <br>
        Eintritt ist alle 20-30 Minuten, zu den folgenden Zeiten möglich:<br>
        - Montags - 9:00-17:00<br>
        - Dienstags-Freitags - 9:20-17:00<br>
        - Samstags, Sonn- und Feiertagen - 9:30-18:00<br>
        Öffnungszeiten können durch Feiertage abweichen. Eine stets aktuelle Liste mit etwaigen Änderungen kann hier gefunden werden: <a href="https://pieskowaskala.eu/godziny-bilety" class="link">Schloss Pieskowa Skała</a>
        ...
        Um den Geocache zu finden, muss zunächst das Listing durchgelesen werden, 2 einfache Rätsel gelöst und der Hof des Schlosses Pieskowa Skała betreten werden. Rätsel Nummer 1 sollte am besten Zuhause gelöst werden, kann aber natürlich auch vor Ort erledigt werden. Rätsel Nummer 2 kann jedoch NUR vor Ort gelöst werden.<br>
        <br>
        Rätsel 1:<br>
        Lies Dir das Listing des Caches genau durch und löse das Rätsel unter folgendem Link:<br>
        <b><a href="https://learningapps.org/watch?v=pksjaoiza23" class="link">Link zum 1. Rätsel.</a></b><br>
        Das Rätsel wird dir einen Code für das <strong>LINKE</strong> Zahlenschloss und die Nordkoordinaten des Caches verraten.<br>
        <br>
        Rätsel 2:<br>
        Besuche Schloss Pieskowa Skała und beantworte die Fragen unter folgendem Link:<br>
        <NuxtLink to="/Quiz2?lang=DE" class="link">Link zum 2. Rätsel.</NuxtLink><br>
        Das Rätsel wird Dir einen Code für das <strong>RECHTE</strong> Zahlenschloss und die Ostkoordinaten des Caches verraten.<br>
        <br />
        Nach dem Lösen und Finden des Caches, hinterlasse bitte wieder alles so, wie Du es vorgefunden hast. <strong>Bitte die Zahlenschlösser nicht vertauschen und auch nicht mit ihnen spielen. </strong>Stelle sicher dass alle Behälter am richtigen Platz sind, damit sie nicht kaputt gehen. Als Belohnung kann man sich eine Urkunde aus dem markierten Behälter nehmen.
      </div>

      <div class="listing__section">
        <span class="listing__section__title">
          <a href="https://coord.info/GCA9WJX" class="link">
            Geocache-Listing auf Geocaching.com
          </a>
        </span>
      </div>
