  ...
  <div class="container">
    <div class="listing">
      ...
      <div class="listing__section">
        ...
        In order to find this geocache it is needed to visit the castle grounds which(<strong>except Mondays - the days of free admission</strong>) is paid. The cheapest ticked is 16PLN (reduced price 13PLN) and includes the guided tour to the cloisters, Dorothy's Rock and warehouse. <strong>Paying for the ticket is required</strong> in order to find this geocache but <strong>using the guide service itself is not obligatory</strong> - After entering the castle, you can leave the group and freely solve the quiz. The final cache itself is also hidden on the castle grounds.<br>
        <br>
        Entrance is possible every 20 or 30 minutes at the following times:<br>
        - Monday - 9:00-17:00<br>
        - Tuesday-Friday - 9:20-17:00<br>
        - Saturday, Sunday, National holidays - 9:30-18:00<br>
        Hours may change due to the public holidays. Always up-to-date list of changes can be found at: <a href="https://pieskowaskala.eu/godziny-bilety" class="link">Pieskowa Skała Castle</a>
        ...
        In order to find the cache, you need to read the listing, solve 2 simple quizes and visit the courtyard of the Pieskowa Skała Castle. Quiz no. 1 is recommended to be solved from home, but you can do it while already visiting the castle too. Puzzle no. 2 requires you to visit the courtyard and solve it there.<br>
        <br>
        Quiz 1:<br>
